...
public class ExtendViewport extends Viewport {
     ...
     */
    public ExtendViewport(Graphics graphics, float minWorldWidth, float minWorldHeight) {
        this(graphics, minWorldWidth, minWorldHeight, 0, 0, new OrthographicCamera(graphics));
    }

    /**
     * Creates a new viewport with no maximum world size.
     */
    public ExtendViewport(Graphics graphics, float minWorldWidth, float minWorldHeight, Camera camera) {
        this(graphics, minWorldWidth, minWorldHeight, 0, 0, camera);
    }

    /**
     * Creates a new viewport using a new {@link OrthographicCamera} and a maximum world size.
     *
     * @see ExtendViewport#ExtendViewport(Graphics, float, float, float, float, Camera)
     */
    public ExtendViewport(Graphics graphics, float minWorldWidth, float minWorldHeight, float maxWorldWidth, float maxWorldHeight) {
        this(graphics, minWorldWidth, minWorldHeight, maxWorldWidth, maxWorldHeight, new OrthographicCamera(graphics));
    }
     ...
     */
    public ExtendViewport(Graphics graphics, float minWorldWidth, float minWorldHeight, float maxWorldWidth, float maxWorldHeight, Camera camera) {
        super(graphics);
