...
public class ScissorStack {
     ...
     */
    public static void calculateScissors(Graphics graphics, Camera camera, Matrix4 batchTransform,
     ...
     */
    public static Rectangle getViewport(Graphics graphics) {
        if (scissors.size == 0) {
            viewport.set(0, 0, graphics.getWidth(), graphics.getHeight());
            return viewport;
        } else {
            Rectangle scissor = scissors.peek();
