...
public class Stage extends InputAdapter implements Disposable {
    ...
    private @Null
    Actor keyboardFocus, scrollFocus;
     ...
     * is disposed.
     */
    public Stage(Graphics graphics, Viewport viewport) {
        this(graphics, viewport, new SpriteBatch(graphics));
        ownsBatch = true;
    }
     ...
     */
    public Stage(Graphics graphics, Viewport viewport, Batch batch) {
    ...
    private @Null
    Actor fireEnterAndExit(@Null Actor overLast, int screenX, int screenY, int pointer) {
    ...
    public Vector2 stageToScreenCoordinates(Vector2 stageCoords) {
        ...
        stageCoords.y = graphics.getHeight() - stageCoords.y;
        return stageCoords;
    }
    ...
    protected boolean isInsideViewport(int screenX, int screenY) {
        ...
        screenY = graphics.getHeight() - 1 - screenY;
