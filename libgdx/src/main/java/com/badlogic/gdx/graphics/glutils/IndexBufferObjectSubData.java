...
public class IndexBufferObjectSubData implements IndexData {
    ...
    private int createBufferObject() {
        ...
        graphics.getGL20().glBindBuffer(GL20.GL_ELEMENT_ARRAY_BUFFER, result);
        graphics.getGL20().glBufferData(GL20.GL_ELEMENT_ARRAY_BUFFER, byteBuffer.capacity(), null, usage);
    ...
    public void setIndices(short[] indices, int offset, int count) {
        ...
        if (isBound) {
            graphics.getGL20().glBufferSubData(GL20.GL_ELEMENT_ARRAY_BUFFER, 0, byteBuffer.limit(), byteBuffer);
            isDirty = false;
        }
    }
