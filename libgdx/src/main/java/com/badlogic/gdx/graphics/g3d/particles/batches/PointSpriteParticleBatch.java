...
public class PointSpriteParticleBatch extends BufferedParticleBatch<PointSpriteControllerRenderData> {
    ...
    public PointSpriteParticleBatch(Graphics graphics) {
        this(graphics, 1000);
    }

    public PointSpriteParticleBatch(Graphics graphics, int capacity) {
        this(graphics, capacity, new ParticleShader.Config(ParticleType.Point));
    }

    public PointSpriteParticleBatch(Graphics graphics, int capacity, ParticleShader.Config shaderConfig) {
