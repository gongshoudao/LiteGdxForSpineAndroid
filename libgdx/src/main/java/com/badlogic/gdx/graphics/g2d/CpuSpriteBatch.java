...
public class CpuSpriteBatch extends SpriteBatch {
     ...
     *
     * @see #SpriteBatch(Graphics)
     */
    public CpuSpriteBatch(Graphics graphics) {
        this(graphics, 1000);
    }
     ...
     *
     * @see #SpriteBatch(Graphics, int)
     */
    public CpuSpriteBatch(Graphics graphics, int size) {
        this(graphics, size, null);
    }

    /**
     * Constructs a CpuSpriteBatch with a custom shader.
     * @see #SpriteBatch(Graphics, int, ShaderProgram)
     */
    public CpuSpriteBatch(Graphics graphics, int size, ShaderProgram defaultShader) {
        super(graphics, size, defaultShader);
    }
