...
public interface TextureArrayData {
    ...
    public static class Factory {
        ...
        public static TextureArrayData loadFromFiles(GL30 gl30, Pixmap.Format format, boolean useMipMaps, FileHandle... files) {
            return new FileTextureArrayData(gl30, format, useMipMaps, files);
        }
