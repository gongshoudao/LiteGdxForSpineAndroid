...
public class ParticleShader extends BaseShader {
    ...
    public static String getDefaultVertexShader() {
        if (defaultVertexShader == null)
            defaultVertexShader = Gdx.files.internal("particles.vertex.glsl").readString();
    ...
    public static String getDefaultFragmentShader() {
        if (defaultFragmentShader == null)
            defaultFragmentShader = Gdx.files.internal("particles.fragment.glsl").readString();
    ...
    public static class Setters {
        ...
        public final static Setter screenWidth = new Setter() {
            ...
            @Override
            public void set(BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
                shader.set(inputID, (float) shader.mGraphics.getWidth());
            }
        };
    ...
    public ParticleShader(final Renderable renderable, Graphics graphics) {
        this(renderable, new Config(), graphics);
    }

    public ParticleShader(final Renderable renderable, final Config config, Graphics graphics) {
        this(renderable, config, createPrefix(renderable, config), graphics);
    }

    public ParticleShader(final Renderable renderable, final Config config, final String prefix, Graphics graphics) {
        this(renderable, config, prefix, config.vertexShader != null ? config.vertexShader : getDefaultVertexShader(),
                config.fragmentShader != null ? config.fragmentShader : getDefaultFragmentShader(), graphics);
    }

    public ParticleShader(final Renderable renderable, final Config config, final String prefix, final String vertexShader,
                          final String fragmentShader, Graphics graphics) {
        this(renderable, config, new ShaderProgram(prefix + vertexShader, prefix + fragmentShader), graphics);
    }

    public ParticleShader(final Renderable renderable, final Config config, final ShaderProgram shaderProgram, Graphics graphics) {
        this.config = config;
        mGraphics = graphics;
