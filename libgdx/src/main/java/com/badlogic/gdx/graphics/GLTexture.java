...
public abstract class GLTexture implements Disposable {
     ...
     */
    public void bind() {
        graphics.getGL20().glBindTexture(glTarget, glHandle);
    }
    ...
    public void bind(int unit) {
        graphics.getGL20().glActiveTexture(GL20.GL_TEXTURE0 + unit);
        graphics.getGL20().glBindTexture(glTarget, glHandle);
    }
    ...
    public void unsafeSetWrap(TextureWrap u, TextureWrap v, boolean force) {
        if (u != null && (force || uWrap != u)) {
            graphics.getGL20().glTexParameteri(glTarget, GL20.GL_TEXTURE_WRAP_S, u.getGLEnum());
            uWrap = u;
        }
        if (v != null && (force || vWrap != v)) {
            graphics.getGL20().glTexParameteri(glTarget, GL20.GL_TEXTURE_WRAP_T, v.getGLEnum());
            vWrap = v;
        }
    }
    ...
    public void unsafeSetFilter(TextureFilter minFilter, TextureFilter magFilter, boolean force) {
        if (minFilter != null && (force || this.minFilter != minFilter)) {
            graphics.getGL20().glTexParameteri(glTarget, GL20.GL_TEXTURE_MIN_FILTER, minFilter.getGLEnum());
            this.minFilter = minFilter;
        }
        if (magFilter != null && (force || this.magFilter != magFilter)) {
            graphics.getGL20().glTexParameteri(glTarget, GL20.GL_TEXTURE_MAG_FILTER, magFilter.getGLEnum());
    ...
    public float unsafeSetAnisotropicFilter(float level, boolean force) {
        ...
        graphics.getGL20().glTexParameterf(GL20.GL_TEXTURE_2D, GL20.GL_TEXTURE_MAX_ANISOTROPY_EXT, level);
    ...
    protected void delete() {
        if (glHandle != 0) {
            graphics.getGL20().glDeleteTexture(glHandle);
            glHandle = 0;
        }
    }
