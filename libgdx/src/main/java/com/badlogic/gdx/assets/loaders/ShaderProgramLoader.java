...
public class ShaderProgramLoader extends AsynchronousAssetLoader<ShaderProgram, ShaderProgramLoader.ShaderProgramParameter> {
    ...
    public ShaderProgramLoader(FileHandleResolver resolver, Application app) {
        super(resolver);
        this.app = app;
    }

    public ShaderProgramLoader(FileHandleResolver resolver, String vertexFileSuffix, String fragmentFileSuffix, Application app) {
        super(resolver);
    ...
    public ShaderProgram loadSync(AssetManager manager, String fileName, FileHandle file, ShaderProgramParameter parameter) {
        ...
        ShaderProgram shaderProgram = new ShaderProgram(app.getGraphics(), vertexCode, fragmentCode);
