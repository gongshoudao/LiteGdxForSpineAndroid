...
public class AssetManager implements Disposable {
     ...
     */
    public AssetManager(Application app) {
        this(new InternalFileHandleResolver(), app);
    }

    /**
     * Creates a new AssetManager with all default loaders.
     */
    public AssetManager(FileHandleResolver resolver, Application app) {
        this(resolver, true, app);
    }
     ...
     */
    public AssetManager(FileHandleResolver resolver, boolean defaultLoaders, Application app) {
        this.resolver = resolver;
        if (defaultLoaders) {
            setLoader(BitmapFont.class, new BitmapFontLoader(resolver, app));
            setLoader(Music.class, new MusicLoader(resolver));
            setLoader(Pixmap.class, new PixmapLoader(resolver));
            setLoader(Sound.class, new SoundLoader(resolver));
            setLoader(TextureAtlas.class, new TextureAtlasLoader(resolver, app));
