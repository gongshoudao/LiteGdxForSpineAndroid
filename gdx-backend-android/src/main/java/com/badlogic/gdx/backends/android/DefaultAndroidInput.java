...
public class DefaultAndroidInput implements AndroidInput {
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        touchHandler.onTouch(app, event, this);
    ...
    void registerSensorListeners() {
        ...
        if (config.useCompass && !rotationVectorAvailable) {
            ...
            compassAvailable = false;
        Log.i("AndroidInput", "sensor listener setup");
    }
    ...
    void unregisterSensorListeners() {
        ...
        Log.i("AndroidInput", "sensor listener tear down");
    }
    ...
    public int lookUpPointerIndex(int pointerId) {
        ...
        Log.i("AndroidInput", "Pointer ID lookup failed: " + pointerId + ", " + sb.toString());
        return -1;
    }
