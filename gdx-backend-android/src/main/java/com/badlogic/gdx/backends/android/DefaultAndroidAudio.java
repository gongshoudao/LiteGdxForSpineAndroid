...
public final class DefaultAndroidAudio implements AndroidAudio {
    ...
    public DefaultAndroidAudio(Application app, Context context, AndroidApplicationConfiguration config) {
        this.app = app;
    ...
    public Music newMusic(FileHandle file) {
        ...
        if (aHandle.type() == FileType.Internal) {
            try {
                ...
                descriptor.close();
                mediaPlayer.prepare();
                AndroidMusic music = new AndroidMusic(app, this, mediaPlayer);
                synchronized (musics) {
                    musics.add(music);
                }
                return music;
